...
export default function HeroSection() {
  return (
    <section className='relative flex flex-col items-center justify-center px-4 py-16 text-center sm:px-8 md:px-12 lg:px-16 lg:py-24 overflow-hidden'>
      {/* Decorative blur circles */}
      <div className='absolute -top-20 -left-20 hidden h-60 w-60 rounded-full bg-primary/20 blur-3xl sm:block lg:h-72 lg:w-72' />
      <div className='absolute -bottom-20 -right-20 hidden h-60 w-60 rounded-full bg-accent/20 blur-3xl sm:block lg:h-72 lg:w-72' />
